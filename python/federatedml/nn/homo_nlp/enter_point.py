...
class HomoNLPServer(HomoNLPBase):
    def __init__(self, trans_var):
        super().__init__(trans_var=trans_var)
        self._init_iteration = 0

    def _init_model(self, param: HomoNLPParam):
        super()._init_model(param)
        # if self.is_version_0():
        #     from federatedml.nn.homo_nlp import _version_0
    ...
    def fit(self, data_inst):
        ...
        # else:
        from federatedml.nn.homo_nlp._torch import build_aggregator
...
class HomoNLPClient(HomoNLPBase):
    def __init__(self, trans_var):
        super().__init__(trans_var=trans_var)
        self._trainer = ...
    ...
    def fit(self, data, *args):
        ...
        # else:
        from federatedml.nn.homo_nlp._torch import build_trainer
    ...
    def predict(self, data):
        ...
        # else:
        from federatedml.nn.homo_nlp._torch import make_predict_dataset
    ...
    def load_model(self, model_dict):
        ...
        #     )
        # else:
        from federatedml.nn.homo_nlp._torch import PyTorchFederatedTrainer
...
class HomoNLPDefaultTransVar(HomoTransferBase):
    def __init__(
...
class HomoNLPDefaultClient(HomoNLPClient):
    def __init__(self):
        super().__init__(trans_var=HomoNLPDefaultTransVar())


class HomoNLPDefaultServer(HomoNLPServer):
    def __init__(self):
        super().__init__(trans_var=HomoNLPDefaultTransVar())
