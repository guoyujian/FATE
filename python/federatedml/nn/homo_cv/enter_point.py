...
class HomoCVServer(HomoCVBase):
    def __init__(self, trans_var):
        super().__init__(trans_var=trans_var)
        self._init_iteration = 0

    def _init_model(self, param: HomoCVParam):
    ...
    def fit(self, data_inst):
        ...
        # else:
        from federatedml.nn.homo_cv._torch import build_aggregator
...
class HomoCVClient(HomoCVBase):
    ...
    def fit(self, data, *args):
        ...
        # else:
        from federatedml.nn.homo_cv._torch import build_trainer
    ...
    def predict(self, data):
        ...
        # else:
        from federatedml.nn.homo_cv._torch import make_predict_dataset
    ...
    def load_model(self, model_dict):
        ...
        #     )
        # else:
        from federatedml.nn.homo_cv._torch import PyTorchFederatedTrainer
...
class HomoCVDefaultTransVar(HomoTransferBase):
    def __init__(
...
class HomoCVDefaultClient(HomoCVClient):
    def __init__(self):
        super().__init__(trans_var=HomoCVDefaultTransVar())


class HomoCVDefaultServer(HomoCVServer):
    def __init__(self):
        super().__init__(trans_var=HomoCVDefaultTransVar())
