...
from federatedml.param import HomoCVParam
...
class FedLightModule(pl.LightningModule):
    def __init__(
        ...
        LOGGER.info("new a model")
        self.model = models.vgg16(pretrained=True)
        self.model.classifier[6] = nn.Linear(in_features=4096, out_features=3, bias=True)
...
def build_trainer(param: HomoCVParam, data, should_label_align=True, trainer=None):
...
def build_aggregator(param: HomoCVParam, init_iteration=0):
