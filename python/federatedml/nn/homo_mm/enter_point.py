...
class HomoMMServer(HomoMMBase):
    def __init__(self, trans_var):
        super().__init__(trans_var=trans_var)
        self._init_iteration = 0

    def _init_model(self, param: HomoMMParam):
    ...
    def fit(self, data_inst):
        ...
        # else:
        from federatedml.nn.homo_mm._torch import build_aggregator
...
class HomoMMClient(HomoMMBase):
    ...
    def fit(self, data, *args):
        ...
        # else:
        from federatedml.nn.homo_mm._torch import build_trainer
    ...
    def predict(self, data):
        ...
        # else:
        from federatedml.nn.homo_mm._torch import make_predict_dataset
    ...
    def load_model(self, model_dict):
        ...
        #     )
        # else:
        from federatedml.nn.homo_mm._torch import PyTorchFederatedTrainer
...
class HomoMMDefaultTransVar(HomoTransferBase):
    def __init__(
...
class HomoMMDefaultClient(HomoMMClient):
    def __init__(self):
        super().__init__(trans_var=HomoMMDefaultTransVar())


class HomoMMDefaultServer(HomoMMServer):
    def __init__(self):
        super().__init__(trans_var=HomoMMDefaultTransVar())
